...
import { Receipt, RotateCcw, ArrowLeft, Download, Share2, Copy } from 'lucide-react';
      ...
      if (isMobile) {
        ...
        if (newWindow) {
          newWindow.document.write(`
            <html>
              <head><title>EasySplit Summary</title></head>
              <body style="margin:0;display:flex;justify-content:center;align-items:center;min-height:100vh;background:#f0f0f0;">
                <img src="${dataURL}" style="max-width:100%;height:auto;" alt="Payment Summary" />
              </body>
            </html>
          `);
        ...
        if (blob && navigator.clipboard && navigator.clipboard.write) {
          try {
            ...
            toast({
              ...
              description: "Payment summary image copied",
            });
          } catch (err) {
            toast({
              title: "Copy failed",
